...
"""
    ...
    catalog={"library_title":"Cybersecurity Governance Source Library","version":"2.0","built":"2026-07-18","source_count":len(records),"categories":sorted({x["category"] for x in records}),"sources":records}
